          ...
          <CardContent className="space-y-6">
            ...
            <div className="relative my-4">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-[var(--card-bg)] px-2 text-[var(--muted)]">Or sign up with</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24">
                  ...
                  <path
                    fill="currentColor"
                    d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.06H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.94l2.85-2.22c-.47-.53-.78-1.2-.84-1.63z"
                  />
                  <path
                    fill="currentColor"
              ...
              <Button
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    console.error('[signup] GitHub OAuth error:', err);
                    setError(message);
                  }
                }}
                className="flex items-center justify-center gap-2"
